...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('user_customer/css/style.css') }}">
...
<body>
    ...
    <header class="text-center py-3" style="background-color: #42280e;">
        ...
        <div class="d-flex align-items-center justify-content-center">
            <img src="{{ asset('user_customer/images/logo.jpg') }}" height="70" class="rounded-circle" alt="Coffee Shop Logo"
