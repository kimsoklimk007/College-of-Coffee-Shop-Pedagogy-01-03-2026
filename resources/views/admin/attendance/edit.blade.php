...
<div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <h4 class="mb-3">{{ __('Edit Attendance Record') }}</h4>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="attendance_date" class="form-control" required value="{{ $attendance->attendance_date }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="time" name="check_in_time" class="form-control" required value="{{ $attendance->check_in_time }}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-select" required>
                                        ...
                                        <option value="On Leave" {{ $attendance->status == 'On Leave' ? 'selected' : '' }}>{{ __('On Leave') }}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
