...
<div class="container mt-3">
    <div class="card shadow-lg p-4 supplier ">
        <h2 class="fw-bold text-center">{{ __('Supplier List') }}</h2>
        ...
        <div class="d-flex justify-content-between align-items-center mb-2">
            ...
            <!-- Search & Filter Section -->
                <form action="" method="get" class="d-flex">
                    <input type="text" name="searchKey" class="form-control me-1" placeholder="{{ __('Search Supplier...') }}" value="{{ request('searchKey') }}">
        ...
        <div class="row" >
                ...
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm h-100" >
                        ...
                        <div class="card-footer bg-light d-flex justify-content-between">
                            ...
                            <form action="{{ route('deleteSupplier', $item->id ) }}" method="POST" onsubmit="return confirm('{{ __('Are you sure you want to delete?') }}');">
                                @csrf
                                @method('DELETE')
            ...
            @empty
                <p class="text-center">{{ __('No suppliers found.') }}</p>
            @endforelse
        </div>
