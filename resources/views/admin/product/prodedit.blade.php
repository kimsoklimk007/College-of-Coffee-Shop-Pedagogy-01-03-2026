    ...
    <div class="row d-flex justify-content-center align-items-centerr">
        <div class="col-lg-10">
            <div class="card border-1 shadow-sm p-4">
                <h2 class="fw-bold mb-4">{{ __('Update Your Product') }}</h2>
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <label class="form-label fw-bold">{{ __('Size') }}</label>
                                ...
                                <div class="col-md-6 mb-4">
                                    <label class="form-label fw-bold">{{ __('Price (MMK)') }}</label>
                                        <input type="text" step="10" id="price" name="price" class="form-control" placeholder="{{ __('Choose size to see price') }}" value="" >
