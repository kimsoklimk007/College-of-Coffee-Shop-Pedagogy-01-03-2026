    ...
    <div class="row justify-content-center mt-3">
        <div class="col-md-6">
            <div class="card shadow-lg p-2">
                <div class="card-body">
                    <h3 class="text-dark fw-bold mb-4 text-center">{{ __('Add Discount') }}</h3>
                    ...
                    <form action="{{ route('adddiscount') }}" method="POST">
                        ...
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label" for="apply_to_all">{{ __('Apply discount to all products') }}</label>
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" name="discount_percentage" id="discount_percentage" class="form-control @error('discount_percentage') is-invalid @enderror" min="0" max="100" placeholder="{{ __('Enter discount percentage') }}">
                        ...
                        <button type="submit" class="btn btn-primary w-100 shadow-sm">{{ __('Create Discount') }}</button>
                    </form>
                    <!-- Form Ends Here -->
                </div>
            </div>
