...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('user_admin/CSS/style.css') }}">
</head>
                    ...
                    <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" id="profileDropdown" role="button"
                        ...
                        @if (auth()->user()->profile == null)
                            <img class="rounded-circle profile-img"
                                src="{{ asset('user_admin/images/undraw_profile.svg') }}">
                        @else
                            <img class="rounded-circle profile-img"
                                src="{{ asset('user_admin/profile_images/' . auth()->user()->profile) }}">
                        @endif
                    </a>
