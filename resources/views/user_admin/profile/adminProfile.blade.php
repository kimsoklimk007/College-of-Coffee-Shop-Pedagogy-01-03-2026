@extends('user_admin.layouts.master')
                                            ...
                                            <div class="d-flex justify-content-center mb-3">
                                                @if (auth()->user()->profile == null)
                                                    <img class="img-profile img-thumbnail rounded-circle"
                                                         id="output" src="{{ asset('user_admin/images/undraw_profile.svg') }}" style="width: 150px;">
                                                @else
                                                    <img class="img-profile img-thumbnail rounded-circle"
                                                         id="output" src="{{ asset('user_admin/profile_images/' . auth()->user()->profile) }}" style="width: 150px;">
                                                @endif
                                            </div>
