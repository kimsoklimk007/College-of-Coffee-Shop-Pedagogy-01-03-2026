...
//List
    public function orderlist()
    {
        ...
        return view('user_admin.order.orderlist', [
...
//View Order(order detail)
    public function viewOrder($orderCode)
    {
        ...
        return view('user_admin.order.orderdetail', compact('details'));
    }
...
//Booking
    public function bookingPage()
    {
        ...
        // dd($orderCode);
        return view('user_admin.order.booking', compact('categories', 'cartOrder'));
    }
...
//after generated new Code and store the code in session
    ...
    public function getProductsByCategory(Request $request)
    {
        ...
        return view('user_admin.order.booking', [
...
// Once Order Confirm Generate Payment Slip
    public function generatePaymentSlip(Request $request)
    {
        ...
        $html = view('user_admin.order.payment-slip', $paymentData)->render();
...
//Print Slip
    public function printPaymentSlip($orderCode)
    {
        ...
        return view('user_admin.order.payment-slip', [
        ...
        return view('user_admin.order.payment-slip', $data);
    }
...
//Payment Record
    public function paymentRecord()
    {
        ...
        return view('user_admin.order.payment-record', compact('records'));
    }
...
//Search Record
    public function searchRecord(Request $request)
    {
        ...
        $html = view('user_admin.order.payment-record', [
            'records'      => $data['records'],
            'subTotalAmt'  => $data['subTotalAmt'],
