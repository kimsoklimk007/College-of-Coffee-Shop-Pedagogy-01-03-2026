...
//Asset Category
    public function index()
    {
        ...
        return view('user_admin.asset.category', compact('categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = AssetCategory::all();
        return view('user_admin.asset.category', compact('categories', 'category'));
    }
...
//Asset Lists
    public function asset_index()
    {
        ...
        return view('user_admin.asset.list', compact('assets'));
    }
    ...
    public function asset_create()
    {
        ...
        return view('user_admin.asset.create', [
    ...
    public function asset_edit($id)
    {
        ...
        return view('user_admin.asset.edit', compact('asset', 'users', 'categories'));
    }
