...
class ProfileController extends Controller
{
    ...
    {
        return view('user_admin.profile.adminProfile');
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            if ($request->oldImage != null) {
                if (file_exists(public_path('/user_admin/profile_images/' . $request->oldImage))) {
                    unlink(public_path('/user_admin/profile_images/' . $request->oldImage));
                }
            }
            //upload new image
            $fileName = uniqid() . $request->file('image')->getClientOriginalName();
            $request->file('image')->move(public_path() . '/user_admin/profile_images/', $fileName);
    ...
    {
        return view('user_admin.profile.overview');
    }
    ...
    {
        return view('user_admin.profile.createprofile');
    }
    ...
    public function changeProfilePage(Request $request)
    {
        ...
        return view('user_admin.profile.changeprofile', compact('users', 'roles'));
    }
