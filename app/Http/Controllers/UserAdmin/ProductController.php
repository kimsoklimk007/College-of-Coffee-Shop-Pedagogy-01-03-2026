...
class ProductController extends Controller
{
    ...
    public function prodlist()
    {
        ...
        return view('user_admin.product.prodlist', compact('products'));
    }

    public function prodcreate()
    {
        $categories = Category::get();
        return view('user_admin.product.prodcreate', compact('categories'));
    }
    ...
    public function prodstore(Request $request)
    {
        ...
        if ($request->hasFile('image')) {
            ...
            $request->file('image')->move(public_path() . '/user_admin/product_images/', $fileName);
            $data['image'] = $fileName;
        }
    ...
    public function prodedit($id)
    {
        ...
        return view('user_admin.product.prodedit', compact('products', 'categories'));
    ...
    public function produpdate(Request $request)
    {
        ...
        // Handle image upload
        if ($request->hasFile('image')) {
            if (file_exists(public_path('user_admin/product_images/' . $request->oldImage))) {
                unlink(public_path('user_admin/product_images/' . $request->oldImage));
            }
    ...
    public function prodsize($id)
    {
        ...
        // dd($product);
        return view('user_admin.product.productsize', compact('product', 'categories'));
    }
    ...
    {
        $product = Product::get();
        return view('user_admin.product.discount', compact('product'));
    }
