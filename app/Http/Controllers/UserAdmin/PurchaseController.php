...
class PurchaseController extends Controller
{
    ...
    public function index(){
        ...
        return view('user_admin.supplier.supplierList', compact('suppliers'));
    }


    //Route to add Supplier
    public function createSupplierPage(){
        return view('user_admin.supplier.createSupplier');
    }
    ...
    public function editSupplier($id){
        ...
        return view ('user_admin.supplier.editSupplier', compact('supplierinfo','totalDueAmount'));
    }
    ...
    public function purchasePage(){
        ...
        return view('user_admin.supplier.purchase', compact('suppliers'));
    }
